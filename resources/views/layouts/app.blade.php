...
<!-- Mirrored from demo.dashboardpack.com/user-management-html/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Aug 2021 09:27:05 GMT -->
<!-- Added by HTTrack -->
...
<body class="crm_body_bg">
    ...
    <nav class="sidebar">
        <div class="logo d-flex justify-content-between">
            ...
            <a class="small_logo" href="index-2.html"><img src="{{ asset('admin/img/2.jpg') }}" style="width: 50px;
                border-radius: 50%; height: 50px;" alt=""></a>
        ...
        <ul id="sidebar_menu">
            ...
            <li class="">
                <a class="has-arrow" href="#" aria-expanded="false">
                    ...
                    <div class="nav_title">
                        <span>Danh sách tên truyện </span>
                    </div>
                </a>
                <ul>
                    <li><a href="{{ route('stories.index') }}">Danh sách tên truyện</a></li>
                    <li><a href="{{ route('stories.create') }}">Thêm tên truyện</a></li>
                </ul>
            </li>
            <li class="">
                <a class="has-arrow" href="#" aria-expanded="false">
                ...
                <ul>
                    ...
                    <li><a href="{{ route('chapters.create') }}">Thêm chương mới</a></li>
                </ul>
            </li>
            <li class="">
                <a class="has-arrow" href="#" aria-expanded="false">
                            ...
                            <div class="header_notification_warp d-flex align-items-center">
                                <li>
                                    ...
                                    <div class="Menu_NOtification_Wrap">
                                        ...
                                        <div class="Notification_body">
                                            ...
                                            <div class="single_notify d-flex align-items-center">
                                                <div class="notify_thumb">
                                                    <a href="#"><img src="{{ asset('admin/img/staf/3.png') }}"
                                                            alt=""></a>
                                                </div>
                                                <div class="notify_content">
                                                    <a href="#">
                                ...
                                <li>
                                    <a class="CHATBOX_open" href="#"> <img
                                            src="{{ asset('admin/img/icon/msg.svg') }}" alt=""> <span>2</span> </a>
                                </li>
                            </div>
...
<!-- Mirrored from demo.dashboardpack.com/user-management-html/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Aug 2021 09:30:12 GMT -->
