...
<body>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{ asset('carousel/image/1.jpg') }}" alt="">
            </div>
            <div class="carousel-item">
                <img src="{{ asset('carousel/image/2.jpg') }}" alt="">
            </div>
            <div class="carousel-item">
                <img src="{{ asset('carousel/image/1.jpg') }}" alt="">
            </div>
    ...
    <script>
        window.jQuery || document.write(
            '<script src="https://getbootstrap.com/docs/4.6/assets/js/vendor/jquery.slim.min.js"><\/script>')
    </script>
